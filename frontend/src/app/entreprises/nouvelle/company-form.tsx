        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <select
              ...
              defaultValue="CAD"
            >
              {/* Repli sur CAD seul si `/meta/company-options` n'a pas pu être
                  chargé : le sélecteur ne doit jamais rester vide. */}
              {(options.currencies.length > 0 ? options.currencies : ["CAD"]).map(
                (code) => (
